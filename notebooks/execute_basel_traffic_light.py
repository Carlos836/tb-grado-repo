...
exec(open('basel_traffic_light.py').read())

# Analyze Traffic Light following Basel Committee methodology
print("Analizando Traffic Light con metodología Basel Committee...")
...
print("\n" + "="*100)
print("ANÁLISIS COMPLETADO - METODOLOGÍA BASEL COMMITTEE")
print("="*100)
